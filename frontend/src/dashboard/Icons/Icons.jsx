...
function Coupons() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125V5.625A1.125 1.125 0 016.75 4.5h10.5a1.125 1.125 0 011.125 1.125v12.75a1.125 1.125 0 01-1.125 1.125h-10.5zM9 9.75h6m-6 3h6m-6 3h6" />
        </svg>
    )
}
...
function Edit() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-6 h-6">
            <path fillRule="evenodd" d="M14.293 5.293a1 1 0 011.414 0l.293.293a1 1 0 010 1.414L7.414 16H4v-3.414l9.586-9.586a1 1 0 011.414 0l.293.293zM15 3a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7l2-2h10z" clipRule="evenodd" />
        </svg>
    )
}
